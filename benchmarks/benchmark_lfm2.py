#!/usr/bin/env python3
"""
Benchmark: LFM2-ColBERT — vLLM in-process (no vanilla reference)

Measures req/s for Mamba/SSM hybrid ColBERT at ~512 tokens with batch=1,8,32.
"""
import gc
import os
import time
...
if __name__ == "__main__":
    print("=" * 70)
    print(f"  LFM2-ColBERT Benchmark — vLLM ({MODEL})")
    print("=" * 70)
