"""LFM2-ColBERT Throughput Benchmark"""
...
def main():
    p = argparse.ArgumentParser(description="LFM2-ColBERT throughput benchmark")
    p.add_argument("--model", default="VAGOsolutions/SauerkrautLM-ColLFM2-450M-v0.1")
