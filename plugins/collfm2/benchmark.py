...
Usage:
    ...
    python plugins/collfm2/serve.py --model <model-id>
...
def main():
    p = argparse.ArgumentParser(description="ColLFM2 throughput benchmark")
    p.add_argument("--model", required=True, help="Model name (must match --served-model-name)")
