"""
IOProcessor plugin for mt5_gliner — server-side GLiNER NER via vLLM's
native IOProcessor pipeline.

Entry-point group: vllm.io_processor_plugins
Entry-point name:  mt5_gliner_io
...
class MT5GLiNERIOProcessor(IOProcessor[GLiNERInput, list[dict[str, Any]]]):
    """IOProcessor for mt5_gliner — GLiNER NER with mT5 backbone.
...
def get_processor_cls() -> str:
    ...
    return "plugins.mt5_gliner.io_processor.MT5GLiNERIOProcessor"
